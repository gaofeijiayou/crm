...
from django.db import models
from privilege import models as pri
...
class UserInfo(models.Model):
    ...
    user=models.OneToOneField(to=pri.User, null=True, on_delete=models.CASCADE)
    def __str__(self):
        return self.name
...
class ClassList(models.Model):
    ...
    teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo',related_name="abc",limit_choices_to={"depart__in":[1000]})
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',limit_choices_to={"depart":1000},on_delete=models.CASCADE)
...
class ConsultRecord(models.Model):
    ...
    客户跟进记录
    """
    customer = models.ForeignKey(verbose_name="所咨询客户", to='Customer', limit_choices_to={'status':2}, on_delete=models.CASCADE)
